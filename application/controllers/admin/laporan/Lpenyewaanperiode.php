...
class Lpenyewaanperiode extends CI_Controller
{
  ...
  function pilih()
  {
    ...
    $this->load->view('admin/laporan/penyewaanperiode/v_pilihperiode');
    $this->load->view('admin/temp/v_footer');
  }
  function pindah()
  {
    $tgl_penyewaanawal = $this->input->post('tgl_penyewaanawal');
    $tgl_penyewaanakhir = $this->input->post('tgl_penyewaanakhir');
    ...
    $session = array(
      'tgl_penyewaanawal' => $tgl_penyewaanawal,
      'tgl_penyewaanakhir' => $tgl_penyewaanakhir,
      'kd_lapangan' => $kd_lapangan,
      'nama_lapangan' => $nama_lapangan
    );
    $this->session->set_userdata($session);
    redirect(base_url('admin/laporan/lpenyewaanperiode/'));
  }

  function index()
  {
    $tgl_penyewaanawal = $this->session->userdata('tgl_penyewaanawal');
    $tgl_penyewaanakhir = $this->session->userdata('tgl_penyewaanawal');
    ...
    if ($kd_lapangan == "all") {
      $data['penyewaan'] = $this->db->query("select * from tbl_penyewaan P, tbl_lapangan L, tbl_jam J, tbl_penyewa S where P.kd_lapangan=L.kd_lapangan and P.kd_jam=J.kd_jam and P.kd_penyewa=S.kd_penyewa and P.tgl_penyewaan >='$tgl_penyewaanawal' AND P.tgl_penyewaan <='$tgl_penyewaanakhir'")->result();
    } else {
      $data['penyewaan'] = $this->db->query("select * from tbl_penyewaan P, tbl_lapangan L, tbl_jam J, tbl_penyewa S where P.kd_lapangan=L.kd_lapangan and P.kd_jam=J.kd_jam and P.kd_penyewa=S.kd_penyewa and P.kd_lapangan='$kd_lapangan' and P.tgl_penyewaan >='$tgl_penyewaanawal' AND P.tgl_penyewaan <='$tgl_penyewaanakhir'")->result();
    }
    ...
    $this->load->view('admin/temp/v_atas');
    $this->load->view('admin/temp/v_sidebar');
    $this->load->view('admin/laporan/penyewaanperiode/v_lpenyewaanperiode');
    $this->load->view('admin/temp/v_footer');
  }
  function laporan_pdf_penyewaanperiode()
  {
    ...
    $this->pdf->load_view('admin/laporan/penyewaanperiode/vlaporanpdfpenyewaanperiode', $data);
