                ...
                <table id="example1" class="table table-bordered table-striped table-hover">
                    <thead class=" bg-aqua ">
                        <tr>
                            ...
                            if ($this->db->query("select * from tbl_service where kd_gaji='$kd_gaji'")->num_rows() > 0) { ?>
                                <th class="text-center text-white">Total Service</th>
                            <?php } ?>
                    ...
                    <tbody>
                        ...
                        foreach ($gaji as $a) :  ?>
                            <tr>
                                ...
                                <?php if ($this->db->query("select * from tbl_service where kd_gaji='$a->kd_gaji'")->num_rows() > 0) { ?>
                                    <td class="text-center text-bold"><?php echo number_format($this->db->query("select total_service from tbl_service where kd_gaji='$a->kd_gaji'")->row()->total_service); ?></td>
                                <?php } ?>
                                <td class="text-center">
                                    <?php if ($this->db->query("select * from tbl_service where kd_gaji='$a->kd_gaji'")->num_rows() > 0) { ?>
                                        <a href="" class="btn btn-info btn-sm mb-1" data-toggle="modal" data-target="#inputdata<?php echo $a->kd_gaji ?>"> <i class="fa fa-plus-circle mr-2"></i>Input service</a>
                                        <?php if ($this->db->query("select sum(insentif_reguler) as total_insentif from tbl_gajidetail where kd_gaji='$a->kd_gaji'")->row()->total_insentif == 0) { ?>
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url('admin/transaksi/service/settingservice') ?>" method="post">
                        <div class="form-group">


                            <label for="">Total Service Bulan <?php echo $a->bulan_gaji ?> </label>
                            <input name="total_service" type="number" class="form-control" required>
    ...
    <div class="modal fade" id="inputdata<?php echo $a->kd_gaji ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url('admin/transaksi/service/inputservicex') ?>" method="post">
                        <div class="form-group">
    ...
    <div class="modal fade" id="unsettingdata<?php echo $a->kd_gaji ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url('admin/transaksi/service/unsettingservice') ?>" method="post">
                        <div class="form-group">
