                ...
                <table id="example1" class="table table-bordered table-striped table-hover">
                    <thead class="bg-aqua">
                        <tr>
                            ...
                            <th class="text-center text-white">Kode Bagian</th>
                            <th class="text-center text-white">Nama Bagian</th>
            ...
            <div class="modal-body">
                <form action="<?php echo base_url('admin/master/bagian/aksitambahbagian') ?>" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input name="kd_bagian" type="text" class="form-control" readonly value="<?php echo $this->Mglobal->kode_otomatis("kd_bagian", "tbl_bagian", "BAG") ?>">
                    </div>
                    <div class="form-group">
