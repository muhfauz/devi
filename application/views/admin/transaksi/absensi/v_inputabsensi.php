                ...
                <table id="example1" class="table table-bordered table-striped table-hover">
                    <thead class="bg-aqua">
                        <tr>
                            ...
                            <th class="text-center text-white align-middle">Jumlah Kehadiran</th>
                    ...
                    <tbody>
                        ...
                        foreach ($karyawan as $a) :  ?>
                            <tr>
                                ...
                                <td class="text-center"><?php echo $a->jumlah_masuk ?> hari</td>
                ...
                <div class="modal-body">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            ...
                            <td><?php echo $a->jumlah_masuk ?> hari</td>
                        </tr>
                        <tr>
                            <th>Foto</th>
                            <td>
