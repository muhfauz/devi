                        ...
                        foreach ($jam as $a) :  ?>
                            <tr>
                                ...
                                <td class="float-right">
                                    <a href="" class="btn btn-primary btn-sm mb-1" data-toggle="modal" data-target="#datadetail<?php echo $a->kd_jam ?>"> <i class="fa fa-plus-square mr-2"></i> Detail</a>
                                    <a href="" class="btn btn-info btn-sm mb-1" data-toggle="modal" data-target="#editdata<?php echo $a->kd_jam ?>"> <i class="fa fa-edit mr-2"></i> Edit</a>
                                    <a href="" class="btn btn-danger btn-sm mb-1" data-toggle="modal" data-target="#hapusdata<?php echo $a->kd_jam ?>"> <i class="fa fa-trash mr-2"></i> Hapus</a>
                                </td>
                            </tr>
                        <?php endforeach ?>
...
<!-- modal detail -->
<?php foreach ($jam as $a) : ?>
    <div class="modal fade" id="datadetail<?php echo $a->kd_jam ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header bg-aqua">
                ...
                <div class="modal-body">
                    <table class="table table-borderless">
                        ...
                        <!-- <tr>
                            <th>Foto jam</th>
                            <td>
                                <img src="<?php echo base_url('assets/toko/images/jam/') . $a->foto_jam ?>" alt="">
                            </td>
                        </tr> -->
...
<?php foreach ($jam as $a) : ?>
    ...
    <div class="modal fade" id="hapusdata<?php echo $a->kd_jam ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url('admin/master/jam/hapusjam') ?>" method="post">
                        <div class="form-group">
...
<?php foreach ($jam as $a) : ?>
    ...
    <div class="modal fade" id="editdata<?php echo $a->kd_jam ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header bg-aqua">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url('admin/master/jam/aksieditjam') ?>" method="post">
                        ...
                        <!-- <div class="form-group">
                            <label for="">Foto jam</label>
                            <img class="form-control img-fluid mb-1" src="<?php echo base_url('assets/toko/images/jam/') . $a->foto_jam ?>" alt="">
                            <input name="foto_jam" type="file" class="form-control" value="<?php echo $a->foto_jam ?>">
                        </div> -->
