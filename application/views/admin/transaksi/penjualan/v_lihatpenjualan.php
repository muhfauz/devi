        ...
        <div class="info-box">
            ...
            <div class="row ml-1 mr-1 mt-3 bg-aqua">
                <div class="col sm-1 mt-2 ml-2 mr-2">
                    ...
                    <div class="form-group row">
                        <label for="exampleInputEmail3" class="col-sm-3 control-label">Total Penjualan </label>
                        <div class="col-sm-9">
                            <div class="input-group">
                    ...
                    <div class="form-group row">
                        <label for="exampleInputEmail3" class="col-sm-3 control-label">Total Komisi </label>
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input class="form-control" id="namaoutlet" placeholder="Nama outlet" type="text" value="<?php echo number_format($total_tunjangan) ?>" readonly>
                                <div class="input-group-addon"><i class="fa fa-check" aria-hidden="true"></i></div>
                            </div>
                        </div>
                    </div>
                ...
                <table id="example1" class="table table-bordered table-striped table-hover">
                    <thead class="bg-aqua">
                        <tr>
                            ...
                            <th class="text-center text-white align-middle">Tunjangan Jabatan</th>
                    ...
                    <tbody>
                        ...
                        foreach ($karyawan as $a) :  ?>
                            <tr>
                                ...
                                <td class="text-center"><?php echo number_format($a->tunjangan_jabatan); ?> </td>
