...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="info-box">
            ...
            <form action="<?php echo base_url('admin/laporan/lpenyewaanperiode/pindah') ?>" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-lg-4">
                        <fieldset class="form-group">
                            <label for="">Dari Tanggal </label>
                            <input name="tgl_penyewaanawal" type="date" class="form-control" required>
                    ...
                    <div class="col-lg-4">
                        <fieldset class="form-group">
                            ...
                            <input name="tgl_penyewaanakhir" type="date" class="form-control" required>
