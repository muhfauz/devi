...
<body>
  ...
  <div class="clearfix">
    ...
    <div class="box">
      : <?php echo $this->Mglobal->tanggalindo($this->session->userdata('tgl_penyewaanawal')); ?>
  ...
  <div class="clearfix">
    ...
    <div class="box">
      : <?php echo $this->Mglobal->tanggalindo($this->session->userdata('tgl_penyewaanakhir')); ?>
  ...
  <div class="clearfix">
    ...
    <div class="box">
      ...
      : Rp. <?php
            ...
            if ($kd_lapangan == 'all') {
              echo $this->Mglobal->rupiah($this->db->query("select sum(jumlah_bayar) as jumlah from tbl_penyewaan where tgl_penyewaan between '$tgl_penyewaanawal' and '$tgl_penyewaanakhir'")->row()->jumlah);
            } else {
              echo $this->Mglobal->rupiah($this->db->query("select sum(jumlah_bayar) as jumlah from tbl_penyewaan where kd_lapangan='$kd_lapangan' and tgl_penyewaan between '$tgl_penyewaanawal' and '$tgl_penyewaanakhir'")->row()->jumlah);
            }
            ?>
