  ...
  <div class="content">
    ...
    <div class="info-box">
      ...
      <div class="row ml-1 mr-1 mt-1 text-right">
        <a href="<?php echo base_url('admin/laporan/lpenyewaanperiode/laporan_pdf_penyewaanperiode') ?>" class="btn btn-secondary bg-aqua-gradient mb-2 text-center"> <i class="fa fa-print mr-2"></i>Cetak PDF</a>
      </div>
      <div class="row ml-1 mr-1 mt-1 bg-aqua">
        ...
        <div class="col sm-1 mt-2 ml-2 mr-2 mb-1">
          ...
          <div class="form-group row">
            <label for="exampleInputEmail3" class="col-sm-3 control-label">Dari Tanggal </label>
            <div class="col-sm-9">
              <div class="input-group">
                <input class="form-control text-left" id="namaoutlet" placeholder="Nama outlet" type="text" value="<?php echo $this->Mglobal->tanggalindo($this->session->userdata('tgl_penyewaanawal')) ?>" readonly>
                <div class="input-group-addon"><i class="fa fa-check" aria-hidden="true"></i></div>
              </div>
            </div>
          </div>
          <div class="form-group row">
            <label for="exampleInputEmail3" class="col-sm-3 control-label">Sampai Tanggal </label>
            <div class="col-sm-9">
              <div class="input-group">
                <input class="form-control text-left" id="namaoutlet" placeholder="Nama outlet" type="text" value="<?php echo $this->Mglobal->tanggalindo($this->session->userdata('tgl_penyewaanakhir')) ?>" readonly>
                <div class="input-group-addon"><i class="fa fa-check" aria-hidden="true"></i></div>
              </div>
            </div>
          </div>
